...
import numpy as np
class SYSUCD(BaseDataset):
    def __init__(self, data_root='data/SYSU_CD', mode='train', transform=None, imgA_dir='time1', imgB_dir='time2', mask_dir='label', img_suffix='.png', mask_suffix='.png', **kwargs):
        super(SYSUCD, self).__init__(transform, mode)
