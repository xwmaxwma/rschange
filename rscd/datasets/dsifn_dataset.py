...
import numpy as np
class DSIFN(BaseDataset):
    def __init__(self, data_root='data/DSIFN', mode='train', transform=None, imgA_dir='t1', imgB_dir='t2', mask_dir='mask', img_suffix='.jpg', mask_suffix='.png', **kwargs):
        super(DSIFN, self).__init__(transform, mode)
        if mode == 'test':
            mask_suffix = '.tif'
        ...
        self.color_map = {
            ...
            'Changed' : np.array([1, 1, 1]),  # label 1
        }
