...
import numpy as np
class LEVIRCD(BaseDataset):
    def __init__(self, data_root='data/LEVIR_CD', mode='train', transform=None, imgA_dir='A', imgB_dir='B', mask_dir='label', img_suffix='.png', mask_suffix='.png', **kwargs):
        super(LEVIRCD, self).__init__(transform, mode)
